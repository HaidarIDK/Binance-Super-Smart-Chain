...
impl Default for Version {
    fn default() -> Self {
        ...
        Self {
            ...
            client: u16::try_from(ClientId::BinanceSuperSmartChain).unwrap(),
        }
    }
}
...
impl From<u16> for ClientId {
    fn from(client: u16) -> Self {
        match client {
            ...
            3u16 => Self::BinanceSuperSmartChain,
...
impl TryFrom<ClientId> for u16 {
    ...
    fn try_from(client: ClientId) -> Result<Self, Self::Error> {
        match client {
            ...
            ClientId::BinanceSuperSmartChain => Ok(3u16),
...
mod test {
    ...
    fn test_client_id() {
        ...
        assert_eq!(ClientId::from(3u16), ClientId::BinanceSuperSmartChain);
        ...
        assert_eq!(u16::try_from(ClientId::BinanceSuperSmartChain), Ok(3u16));
